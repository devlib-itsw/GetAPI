...
public class SmsAuthController {
	...
	public String returnHtml(@RequestParam("token") String token, Model model) {
	...
	public void notifyVerified(String token, String email, String name, String picture) {
		// JWT 생성 후 임시 저장 (프론트에서 /smsVerify/complete로 요청 시 쿠키로 설정)
		String jwt = jwtUtil.generateToken(email, name, picture);
	...
	@GetMapping("/smsVerify/complete")
	public void completeVerification(@RequestParam("token") String token, HttpServletResponse response) throws IOException {
